...
def stats_plot_from_db(request):
    ...
    return render_to_response('gviz-test-new.html', {'json1': json_str1['mcnt'], 
...
def stats_plot(request):
    ...
    json6 = get_barplot_ival_jsonstr(avg=avgarr, min=minarr, max=maxarr, gender='A')
    json7 = get_barplot_ival_jsonstr(avg=medianarr, min=minarr, max=q75arr, gender='A')
    ...
    json17 = get_barplot_ival_jsonstr(avg=medianarr_sp, min=minarr_sp, max=q75arr_sp, gender='A')
