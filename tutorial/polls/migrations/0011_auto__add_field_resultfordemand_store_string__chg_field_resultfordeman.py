...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ResultForDemand.store_string'
        db.add_column('polls_resultfordemand', 'store_string', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=10), keep_default=False)

        # Changing field 'ResultForDemand.itemlist'
        db.alter_column('polls_resultfordemand', 'itemlist_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.ItemList'], null=True))

        # Changing field 'ResultForDemand.demand'
        db.alter_column('polls_resultfordemand', 'demand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Demand'], null=True))

        # Changing field 'ItemList.item8'
        db.alter_column('polls_itemlist', 'item8_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item9'
        db.alter_column('polls_itemlist', 'item9_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item2'
        db.alter_column('polls_itemlist', 'item2_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item3'
        db.alter_column('polls_itemlist', 'item3_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item1'
        db.alter_column('polls_itemlist', 'item1_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item6'
        db.alter_column('polls_itemlist', 'item6_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item7'
        db.alter_column('polls_itemlist', 'item7_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item4'
        db.alter_column('polls_itemlist', 'item4_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item5'
        db.alter_column('polls_itemlist', 'item5_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item14'
        db.alter_column('polls_itemlist', 'item14_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item15'
        db.alter_column('polls_itemlist', 'item15_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item16'
        db.alter_column('polls_itemlist', 'item16_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item10'
        db.alter_column('polls_itemlist', 'item10_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item11'
        db.alter_column('polls_itemlist', 'item11_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item12'
        db.alter_column('polls_itemlist', 'item12_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))

        # Changing field 'ItemList.item13'
        db.alter_column('polls_itemlist', 'item13_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['polls.Items']))


    def backwards(self, orm):
        
        # Deleting field 'ResultForDemand.store_string'
        db.delete_column('polls_resultfordemand', 'store_string')

        # Changing field 'ResultForDemand.itemlist'
        db.alter_column('polls_resultfordemand', 'itemlist_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.ItemList']))

        # Changing field 'ResultForDemand.demand'
        db.alter_column('polls_resultfordemand', 'demand_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Demand']))

        # Changing field 'ItemList.item8'
        db.alter_column('polls_itemlist', 'item8_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item9'
        db.alter_column('polls_itemlist', 'item9_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item2'
        db.alter_column('polls_itemlist', 'item2_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item3'
        db.alter_column('polls_itemlist', 'item3_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item1'
        db.alter_column('polls_itemlist', 'item1_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item6'
        db.alter_column('polls_itemlist', 'item6_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item7'
        db.alter_column('polls_itemlist', 'item7_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item4'
        db.alter_column('polls_itemlist', 'item4_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item5'
        db.alter_column('polls_itemlist', 'item5_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item14'
        db.alter_column('polls_itemlist', 'item14_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item15'
        db.alter_column('polls_itemlist', 'item15_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item16'
        db.alter_column('polls_itemlist', 'item16_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item10'
        db.alter_column('polls_itemlist', 'item10_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item11'
        db.alter_column('polls_itemlist', 'item11_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item12'
        db.alter_column('polls_itemlist', 'item12_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))

        # Changing field 'ItemList.item13'
        db.alter_column('polls_itemlist', 'item13_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.Items']))
    ...
    models = {
        ...
        'polls.resultfordemand': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 12, 9, 33, 49, 929305)'}),
