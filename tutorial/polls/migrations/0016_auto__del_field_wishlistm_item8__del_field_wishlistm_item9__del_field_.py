...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('polls_wishlistm', 'item8', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist8', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)

        # Adding field 'WishlistM.item9'
        db.add_column('polls_wishlistm', 'item9', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist9', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)

        # Adding field 'WishlistM.item2'
        db.add_column('polls_wishlistm', 'item2', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist2', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)

        # Adding field 'WishlistM.item3'
        db.add_column('polls_wishlistm', 'item3', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist3', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)

        # Adding field 'WishlistM.item6'
        db.add_column('polls_wishlistm', 'item6', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist6', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)

        # Adding field 'WishlistM.item7'
        db.add_column('polls_wishlistm', 'item7', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist7', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)

        # Adding field 'WishlistM.item4'
        db.add_column('polls_wishlistm', 'item4', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist4', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)

        # Adding field 'WishlistM.item11'
        db.add_column('polls_wishlistm', 'item11', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist11', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)

        # Adding field 'WishlistM.item14'
        db.add_column('polls_wishlistm', 'item14', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist14', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)

        # Adding field 'WishlistM.item15'
        db.add_column('polls_wishlistm', 'item15', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist15', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)

        # Adding field 'WishlistM.item16'
        db.add_column('polls_wishlistm', 'item16', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist16', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)

        # Adding field 'WishlistM.item5'
        db.add_column('polls_wishlistm', 'item5', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist5', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)

        # Adding field 'WishlistM.item10'
        db.add_column('polls_wishlistm', 'item10', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist10', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)

        # Adding field 'WishlistM.item12'
        db.add_column('polls_wishlistm', 'item12', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist12', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)

        # Adding field 'WishlistM.item13'
        db.add_column('polls_wishlistm', 'item13', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', related_name='prodlist13', null=True, to=orm['polls.ProductModel'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'polls.resultfordemand': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 19, 18, 34, 7, 185828)'}),
