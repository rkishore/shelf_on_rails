...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('polls_colorsizemodel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', to=orm['polls.ProductModel'])),
        ...
        db.send_create_signal('polls', ['ColorSizeModel'])

        # Adding model 'ProductModel'
        db.create_table('polls_productmodel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('brand', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', to=orm['polls.Brands'])),
            ('idx', self.gf('django.db.models.fields.IntegerField')(default='Nil', max_length=10)),
            ...
            ('price', self.gf('django.db.models.fields.FloatField')(default='Nil', max_length=10)),
            ('saleprice', self.gf('django.db.models.fields.FloatField')(default='Nil', max_length=10)),
        ...
        db.send_create_signal('polls', ['ProductModel'])

        # Adding model 'CategoryModel'
        db.create_table('polls_categorymodel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', to=orm['polls.ProductModel'])),
            ('categoryId', self.gf('django.db.models.fields.IntegerField')(default='Nil', max_length=50)),
            ('categoryName', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=50)),
        ))
        db.send_create_signal('polls', ['CategoryModel'])


    def backwards(self, orm):
        
        # Deleting model 'ColorSizeModel'
        db.delete_table('polls_colorsizemodel')

        # Deleting model 'ProductModel'
        db.delete_table('polls_productmodel')

        # Deleting model 'CategoryModel'
        db.delete_table('polls_categorymodel')
    ...
    models = {
        ...
        'polls.resultfordemand': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 18, 21, 3, 51, 77734)'}),
