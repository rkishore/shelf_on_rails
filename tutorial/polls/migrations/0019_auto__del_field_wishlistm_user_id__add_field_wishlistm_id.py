...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WishlistM.user_id'
        db.delete_column('polls_wishlistm', 'user_id')

        # Adding field 'WishlistM.id'
        db.add_column('polls_wishlistm', 'id', self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'WishlistM.user_id'
        db.add_column('polls_wishlistm', 'user_id', self.gf('django.db.models.fields.IntegerField')(default='-1111', max_length=50, primary_key=True), keep_default=False)
    ...
    models = {
        ...
        'polls.resultfordemand': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 19, 18, 40, 51, 423071)'}),
