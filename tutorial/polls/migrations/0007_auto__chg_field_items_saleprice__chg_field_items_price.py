...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Items.saleprice'
        db.alter_column('polls_items', 'saleprice', self.gf('django.db.models.fields.FloatField')(max_length=10))

        # Changing field 'Items.price'
        db.alter_column('polls_items', 'price', self.gf('django.db.models.fields.FloatField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'Items.saleprice'
        db.alter_column('polls_items', 'saleprice', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Items.price'
        db.alter_column('polls_items', 'price', self.gf('django.db.models.fields.CharField')(max_length=10))
