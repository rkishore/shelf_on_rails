...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('polls_storeitemcombinationresults', (
        ...
        db.send_create_signal('polls', ['StoreItemCombinationResults'])


    def backwards(self, orm):
        
        # Deleting model 'StoreItemCombinationResults'
        db.delete_table('polls_storeitemcombinationresults')
    ...
    models = {
        ...
        'polls.resultfordemand': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 21, 23, 41, 8, 770709)'}),
