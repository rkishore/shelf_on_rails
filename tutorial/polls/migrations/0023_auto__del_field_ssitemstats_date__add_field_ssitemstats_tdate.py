...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SSItemStats.date'
        db.delete_column('polls_ssitemstats', 'date')

        # Adding field 'SSItemStats.tdate'
        db.add_column('polls_ssitemstats', 'tdate', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 1, 21, 18, 42, 45, 139597)), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'SSItemStats.date'
        db.add_column('polls_ssitemstats', 'date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 1, 21, 18, 39, 17, 399145)), keep_default=False)

        # Deleting field 'SSItemStats.tdate'
        db.delete_column('polls_ssitemstats', 'tdate')
    ...
    models = {
        ...
        'polls.resultfordemand': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 21, 18, 42, 45, 139141)'}),
        ...
        'polls.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 21, 18, 42, 45, 139597)'}),
