...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Items.img_url_sm'
        db.add_column('polls_items', 'img_url_sm', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=100), keep_default=False)

        # Adding field 'Items.img_url_md'
        db.add_column('polls_items', 'img_url_md', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=100), keep_default=False)

        # Adding field 'Items.img_url_lg'
        db.add_column('polls_items', 'img_url_lg', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Items.img_url_sm'
        db.delete_column('polls_items', 'img_url_sm')

        # Deleting field 'Items.img_url_md'
        db.delete_column('polls_items', 'img_url_md')

        # Deleting field 'Items.img_url_lg'
        db.delete_column('polls_items', 'img_url_lg')
    ...
    models = {
        ...
        'polls.items': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'img_url_lg': ('django.db.models.fields.CharField', [], {'default': "'Nil'", 'max_length': '100'}),
            'img_url_md': ('django.db.models.fields.CharField', [], {'default': "'Nil'", 'max_length': '100'}),
            'img_url_sm': ('django.db.models.fields.CharField', [], {'default': "'Nil'", 'max_length': '100'}),
