...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('polls_useridmap', (
        ...
        db.send_create_signal('polls', ['UserIdMap'])

        # Renaming column for 'WishlistI.user_id' to match new field type.
        db.rename_column('polls_wishlisti', 'user_id', 'user_id_id')
        # Changing field 'WishlistI.user_id'
        db.alter_column('polls_wishlisti', 'user_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polls.UserIdMap']))

        # Adding index on 'WishlistI', fields ['user_id']
        db.create_index('polls_wishlisti', ['user_id_id'])


    def backwards(self, orm):
        
        # Removing index on 'WishlistI', fields ['user_id']
        db.delete_index('polls_wishlisti', ['user_id_id'])

        # Deleting model 'UserIdMap'
        db.delete_table('polls_useridmap')

        # Renaming column for 'WishlistI.user_id' to match new field type.
        db.rename_column('polls_wishlisti', 'user_id_id', 'user_id')
        # Changing field 'WishlistI.user_id'
        db.alter_column('polls_wishlisti', 'user_id', self.gf('django.db.models.fields.IntegerField')(max_length=50))
    ...
    models = {
        ...
        'polls.resultfordemand': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 23, 13, 9, 11, 76265)'}),
        ...
        'polls.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 23, 13, 9, 11, 76697)'}),
        ...
        'polls.wishlisti': {
            ...
            'user_id': ('django.db.models.fields.related.ForeignKey', [], {'default': "'Nil'", 'to': "orm['polls.UserIdMap']"})
        },
        'polls.wishlistm': {
