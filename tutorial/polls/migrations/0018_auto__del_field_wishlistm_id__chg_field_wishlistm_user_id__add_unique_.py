...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WishlistM.id'
        db.delete_column('polls_wishlistm', 'id')

        # Changing field 'WishlistM.user_id'
        db.alter_column('polls_wishlistm', 'user_id', self.gf('django.db.models.fields.IntegerField')(max_length=50, primary_key=True))

        # Adding unique constraint on 'WishlistM', fields ['user_id']
        db.create_unique('polls_wishlistm', ['user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'WishlistM', fields ['user_id']
        db.delete_unique('polls_wishlistm', ['user_id'])

        # Adding field 'WishlistM.id'
        db.add_column('polls_wishlistm', 'id', self.gf('django.db.models.fields.AutoField')(default=99, primary_key=True), keep_default=False)

        # Changing field 'WishlistM.user_id'
        db.alter_column('polls_wishlistm', 'user_id', self.gf('django.db.models.fields.IntegerField')(max_length=50))
    ...
    models = {
        ...
        'polls.resultfordemand': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 19, 18, 39, 23, 918005)'}),
        ...
        'polls.wishlistm': {
            ...
            'user_id': ('django.db.models.fields.IntegerField', [], {'default': "'-1111'", 'max_length': '50', 'primary_key': 'True'})
        }
    }
