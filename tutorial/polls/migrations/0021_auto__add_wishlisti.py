...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('polls_wishlisti', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_id', self.gf('django.db.models.fields.IntegerField')(default='-1111', max_length=50)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(default='Nil', to=orm['polls.ProductModel'], null=True, blank=True)),
        ))
        db.send_create_signal('polls', ['WishlistI'])


    def backwards(self, orm):
        
        # Deleting model 'WishlistI'
        db.delete_table('polls_wishlisti')
    ...
    models = {
        ...
        'polls.resultfordemand': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 19, 21, 50, 33, 123509)'}),
