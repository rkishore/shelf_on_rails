...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Items.pr_instock'
        db.add_column('polls_items', 'pr_instock', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=10), keep_default=False)

        # Adding field 'Items.pr_retailer'
        db.add_column('polls_items', 'pr_retailer', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=200), keep_default=False)

        # Adding field 'Items.pr_currency'
        db.add_column('polls_items', 'pr_currency', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Items.pr_instock'
        db.delete_column('polls_items', 'pr_instock')

        # Deleting field 'Items.pr_retailer'
        db.delete_column('polls_items', 'pr_retailer')

        # Deleting field 'Items.pr_currency'
        db.delete_column('polls_items', 'pr_currency')
