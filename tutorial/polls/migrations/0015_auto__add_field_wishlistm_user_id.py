...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('polls_wishlistm', 'user_id', self.gf('django.db.models.fields.IntegerField')(default='Nil', max_length=50), keep_default=False)
    ...
    models = {
        ...
        'polls.resultfordemand': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 19, 17, 59, 22, 529786)'}),
        ...
        'polls.wishlistm': {
            ...
            'user_id': ('django.db.models.fields.IntegerField', [], {'default': "'Nil'", 'max_length': '50'})
        }
    }
