...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Items.pr_sizes'
        db.add_column('polls_items', 'pr_sizes', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=200), keep_default=False)

        # Adding field 'Items.pr_colors'
        db.add_column('polls_items', 'pr_colors', self.gf('django.db.models.fields.CharField')(default='Nil', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Items.pr_sizes'
        db.delete_column('polls_items', 'pr_sizes')

        # Deleting field 'Items.pr_colors'
        db.delete_column('polls_items', 'pr_colors')
