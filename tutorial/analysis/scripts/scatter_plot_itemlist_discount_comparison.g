...
plot	"../data/overall_itemlist_br_max_with_disc.txt" using 1:4 title "Banana Republic" pt 1, \
	"../data/overall_itemlist_j.crew_max_with_disc.txt" using 1:4 title "J.Crew" pt 2, \
	"../data/overall_itemlist_express_max_with_disc.txt" using 1:4 title "Express" pt 3
...
set ylabel "Discount %"
plot	"../data/overall_itemlist_br_median_with_disc.txt" using 1:4 title "Banana Republic" pt 1, \
	"../data/overall_itemlist_j.crew_median_with_disc.txt" using 1:4 title "J.Crew" pt 2, \
	"../data/overall_itemlist_express_median_with_disc.txt" using 1:4 title "Express" pt 3
