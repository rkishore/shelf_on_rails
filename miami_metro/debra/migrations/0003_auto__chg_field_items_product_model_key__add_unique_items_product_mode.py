...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Items.product_model_key'
        db.alter_column('debra_items', 'product_model_key_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['debra.ProductModel'], unique=True, null=True))

        # Adding unique constraint on 'Items', fields ['product_model_key']
        db.create_unique('debra_items', ['product_model_key_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Items', fields ['product_model_key']
        db.delete_unique('debra_items', ['product_model_key_id'])

        # Changing field 'Items.product_model_key'
        db.alter_column('debra_items', 'product_model_key_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['debra.ProductModel'], null=True))
    ...
    models = {
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 30, 16, 59, 51, 372735)'}),
