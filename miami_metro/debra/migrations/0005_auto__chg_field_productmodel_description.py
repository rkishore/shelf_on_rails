...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductModel.description'
        db.alter_column('debra_productmodel', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000))


    def backwards(self, orm):
        
        # Changing field 'ProductModel.description'
        db.alter_column('debra_productmodel', 'description', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        'debra.productmodel': {
            ...
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'default': "'1'", 'to': "orm['debra.Brands']"}),
            'description': ('django.db.models.fields.CharField', [], {'default': "'Nil'", 'max_length': '1000'}),
        ...
        'debra.ssitemstats': {
            ...
            'tdate': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 1, 30, 20, 22, 56, 209706)'}),
